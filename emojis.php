<?php
function cache_emojis()
{
    if (!file_exists(DIR_BASE . 'Cache\emojis.php')) {
        ...
        file_put_contents(DIR_BASE . 'Cache' . DIRECTORY_SEPARATOR . 'emojis.php', '<?php return ' . var_export($emojis,
                true) . ';');
    }
}
